...
class NBodyDataset():
    ...
    def load(self):
        loc = np.load('data/loc_' + self.sufix + '.npy')
        vel = np.load('data/vel_' + self.sufix + '.npy')
        edges = np.load('data/edges_' + self.sufix + '.npy')
        charges = np.load('data/charges_' + self.sufix + '.npy')
